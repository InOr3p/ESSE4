package mat.unical.it.progettouid2022.client;


import client.util.QueryResult;
import mat.unical.it.progettouid2022.client.listeners.ErrorListener;
import mat.unical.it.progettouid2022.client.listeners.SuccessListener;
            ...
            try {
                ...
                if(successListener != null) {
                    ...
                    synchronized (oggettoSynchronized.getInstance()) {
                        oggettoSynchronized.getInstance().notify();
                    }
                }
            } catch (Exception e) {
                if(errorListener != null)
